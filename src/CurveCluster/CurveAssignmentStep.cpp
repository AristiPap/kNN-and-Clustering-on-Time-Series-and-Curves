...
uint32_t reverse_assignment_lsh_curves(vector<CurveCentroid> &centroids,
    ...
    static  LSHSolver solver(dataset, KMeans_Solver::lsh_L, CLUSTERING_DELTA, dataset.front()->dimensions(), 0, "LSH", 1, KMeans_Solver::lsh_k, 4, 10, 2, dataset.front()->complexity()*2 - 1);
