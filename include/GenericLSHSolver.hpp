...
public:
    LSHSolver(std::list<Curve *> &dataset, uint32_t curve_L, uint32_t curve_delta, uint32_t curve_d, std::string storage_type="LSH", uint32_t _L=5, uint32_t k=4, uint32_t dd=14, uint32_t M=10, uint32_t probes=2, int flag = 0);
    ~LSHSolver();
