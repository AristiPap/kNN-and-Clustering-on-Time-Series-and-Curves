...
according to the formula ![formula](https://render.githubusercontent.com/render/math?math=$c'%20=%20floor(\frac{(x%20-%20t)}{\delta}%20%2B%20\frac{1}{2})%20\cdot%20\delta%20%2B%20t,%20\;%20x%20\in%20Points(c)$)
